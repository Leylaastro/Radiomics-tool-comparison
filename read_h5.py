#This code reads the h5 file and saves the IDs of patients in an excel file
import h5py
import numpy as np
...
file_h5 = os.path.join(main_dir_path, 'generated.h5')
#reading the h5 file
f = h5py.File(file_h5)
#list of patients
...
file_oncotech_ids = os.path.join(main_dir_path,'sample_ids.xlsx')
